...
if obj.needs_updating
    ...
    %% we should also be able to calculate the principal curvatures and the directions of principal curvatures
    %%%% also the principal direction ---- consult 1993_Duncan and Olson
